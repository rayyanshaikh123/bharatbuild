...
import { Eye, EyeOff, ShieldCheck, UserCog, Briefcase, Building2, Loader2 } from "lucide-react"
...
export default function SignupForm() {
  ...
  const [role, setRole] = useState<"admin" | "owner" | "manager">("manager")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    clearError()
    await register({ email, password, username, organization, role })
  }
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-6 px-8">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={role}
                  onValueChange={(value: "admin" | "owner" | "manager") => setRole(value)}
                  disabled={loading}
                >
                  <SelectTrigger
                    id="role"
