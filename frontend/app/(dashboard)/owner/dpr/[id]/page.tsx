...
import { ownerDpr } from "@/lib/api/owner";
...
export default function OwnerDprDetailPage() {
    ...
    if (dpr && dpr.report_image && !imageUrl) {
      const fetchImage = async () => {
        try {
          ...
          const blob = await ownerDpr.getImage(dpr.id);
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pt-12 md:pt-0 pb-12">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold">DPR Details</h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass-card rounded-2xl p-6">
            ...
            {/* Owner Read-Only Remarks Display if any */}
            {dpr.remarks && (
               <div className="mt-4 p-4 bg-muted/30 rounded-xl border border-border">
                <p className="text-xs text-muted-foreground mb-1">
                  Manager Remarks
                </p>
                <p className="text-sm italic">"{dpr.remarks}"</p>
              </div>
            )}
          </div>
          ...
          <div className="glass-card rounded-2xl p-6">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground whitespace-pre-wrap">
              {dpr.description || dpr.work_description}
            </p>
          </div>
